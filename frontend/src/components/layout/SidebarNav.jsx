 ...
 * Response, etc. grow into their own dedicated views, these same items
 * become routes with the icon/label/badge structure already in place;
 * nothing about this component's shape has to change, only what onClick
 * does.
 */
const SECTIONS = [
...
export function SidebarNav({ activeId, openCaseCount, dryRun, onOpenSettings }) {
  const jumpTo = (id) => {
